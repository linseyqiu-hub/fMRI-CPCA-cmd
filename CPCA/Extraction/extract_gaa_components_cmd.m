function [abort_proc,Zheader] = extract_gaa_components_cmd( Zheader, scan_information , nd, log_fid, GAtyp )
...
if ( has_dir )
    ...
    if (  has_GC_var_cmd(Zheader, GAheader, cc_var, GAtyp ) )		% BB file has been created
        ...
        B = load_GC_var_cmd(Gheader, Zheader, 'B', GAtyp );
        ...
        cvariance_unrotated_tot = component_variance_cmd(Zheader, Aheader.model( Aheader.Aindex).sd(2), V );
        ...
        pca_summary_cmd(Zheader,scan_information, Aheader.model( Aheader.Aindex).sd(2), 'GnotA', cvariance_unrotated_tot, fid );
        ...
        pca_summary_cmd(Zheader,scan_information, Aheader.model( Aheader.Aindex).sd(2), 'GnotA', cvariance_unrotated_tot, 1 );
