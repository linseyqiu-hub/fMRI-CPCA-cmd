function rotate_subject_components_cmd(Zheader, scan_information, rotation_params, nd, log_fid, mask_registry )
...
for SubjectNo = 1:Zheader.num_subjects
    ...
    eval( ['cvariance_rotated_tot = component_variance_cmd(Zheader, Gheader.GZheader.sum_diagonal, alt_VR_S' num2str(SubjectNo) ''' );' ] );
    ...
    pca_summary_cmd(Zheader,scan_information, sd, tag, cvariance_rotated_tot, fid, tsum );
    ...
    g_images_rotated_alt_vr_cmd(Zheader, scan_information, this_rotation, SubjectNo, nd, log_fid, mask_registry  );
...
text_file_header_cmd(Zheader, scan_information, nd, fid, 0, outdir, values_out, 0, nvox );
