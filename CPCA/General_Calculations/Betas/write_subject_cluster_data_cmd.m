function write_subject_cluster_data_cmd(Zheader, scan_information, rotation_params, subject_VR, MNI, subject_no )
...
for comp = 1:rotation_params.nd
    ...
    for thr = 1:size(MNI.component(comp).threshold,1)
        ...
        if is_active_threshold(thr)
            ...
            text_file_header_cmd(Zheader, scan_information, rotation_params.nd, fid, 0, cp, Zheader.total_columns );
