function recreate_gmh_images_cmd(Zheader, scan_information, rotation_params, model, nd, comps_to_flip )
...
%      end
      ...
      if ( component_no == 1 )
        text_file_header_cmd(Zheader, scan_information, nd, fid, 0, component_directory, MNI_out );
