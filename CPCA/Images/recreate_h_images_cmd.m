function recreate_h_images_cmd(Zheader, scan_information, rotation_settings, model, nd, log_fid )
...
%      component_image.vol.private.dat.dtype = dtype;
      ...
      show_clusters_cmd( 'positive', clusters.pos, log_fid, fid, MNI_output, component_no );
      show_clusters_cmd( 'negative', clusters.neg, log_fid, fid, MNI_output, component_no );

      if ( fid)  fclose(fid); end

      clusters = calc_cluster_masks_cmd(scan_information, clusters );
