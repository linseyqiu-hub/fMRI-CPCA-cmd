...
config.outputDIR = 'D:\fMRI-CPCA\mask_inconsistency_harvard';  % e.g., 'D:\fMRI-CPCA\output'
...
config.solutions(2).num_components    = 2;
config.solutions(2).rotation_method   = 'hrfmax';
config.solutions(2).hrfmax_shapes_path = 'D:\example_data_Multiple_Groups_Subjects_Runs - copy\shapes.mat';  % → hrf_file
config.solutions(2).hrfmax_shapes_var  = 'shapes';               % → hrf_mat (variable name inside the .mat)
