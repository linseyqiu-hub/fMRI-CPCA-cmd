function plot_HRF_cmd(Zheader, scan_information, out_dir, PR, Gheader, params )
  ...
  for comp = 1:size(PR,2)
    ...
    for cond = 1:nconds
      ...
      for SubjectNo = 1:Zheader.num_subjects
        ...
        [encoded sr er] = PR_condition_position_cmd(Zheader, scan_information, SubjectNo, cond, Gheader );
        if encoded
          temp = PR(sr:er,comp);
