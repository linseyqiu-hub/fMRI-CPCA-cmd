function [encoded sr er] = PR_condition_position_cmd(Zheader, scan_information, subject, condition, Gheader )

  sr = 0;
  er = 0;

  encoded = isEncoded_cmd(Zheader, scan_information, subject, condition );
  if ~encoded
    return;
  end
